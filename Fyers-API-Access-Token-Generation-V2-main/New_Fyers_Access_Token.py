...
username = "XA01288"  # fyers_id
password = "Asansol4$"  # fyers_password
pin = 2140  # your integer pin
client_id = "85VLN1I8IV-100"  # "L9NY****W-100" (Client_id here refers to APP_ID of the created app)
secret_key = "Y8YDOYMEZZ"  # app_secret key which you got after creating the app
